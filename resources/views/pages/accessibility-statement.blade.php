...
@php
    $seoTitle = 'ACCESSIBILITY STATEMENT | marina.newyorkcity';
    $seoDescription = 'Accessibility statement for marinanewyorkcity.com.';
@endphp
    ...
    <section class="section page">
        <div class="wrap">
            <div class="section-head fade-up">
                <h1 class="display t-h1">ACCESSIBILITY STATEMENT</h1>
            </div>
